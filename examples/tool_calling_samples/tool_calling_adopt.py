...
async def run_tool_calling_example():
    ...
    agent = await create_adopt_agents(
        ...
        tools=ToolsConfig(
            capability_keys=[
                "deactivate_a_keyword_from_track",
                "change_the_category_of_keyword",
                "view_keyword_within_keyword_group",
                "display_organization_product_details",
                "add_new_keywords",
                "update_the_group_of_keyword",
                "show_all_keywords",
                "show_all_keyword_groups",
                "show_all_the_deactivated_keywords",
                "get_authenticated_user_and_organization_details"
            ],
            profile=profile,
            execution_type="TOOL"
        ),
        middleware=[
            ...
            MiddlewareSpec("llm_tool_selector", { #here it will use default values 
                "model": openai_model
            }),
